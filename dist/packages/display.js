...
var _pixi_display = (function (exports, settings, math, utils) {
    ...
    ***************************************************************************** */
    ...
    var Container = /** @class */ (function (_super) {
        ...
        function Container() {
            var _this = _super.call(this) || this;
            _this._baseDistance = 0;
            // protected _cameraFOV: number = 75;//degrees
            _this._distance = 0;
            /**
        ...
        Object.defineProperty(Container.prototype, "distance", {
            // /for faux 3D
            get: function () {
        ...
        Object.defineProperty(Container.prototype, "baseDistance", {
            get: function () {
        ...
        // }
        // set cameraFOV(value: number) {
        //     this._cameraFOV = value;
        //     this.recalcScale();
        // }
        Container.prototype.recalcScale = function () {
            if (this._baseDistance == 0) {
                // can't fake scale if base distance is not >0
                console.error('base distance must be nonzero to reacalcScale ');
                return;
            }
            // so at baseDistance, the scale is 1.0
            // if we use 1/distance to calculate size, then we can recalculate based on that
            var baseScaleValue = 1 / this._baseDistance;
            var relativeScaleValue = 1 / this._distance;
            var newScaleValue = relativeScaleValue / baseScaleValue;
            this.scale.set(newScaleValue, newScaleValue);
        };
        return Container;
    }(DisplayObject));
    /**
